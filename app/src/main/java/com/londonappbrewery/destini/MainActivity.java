...
public class MainActivity extends AppCompatActivity {
    ...
    private TopBottom[] mStoryWay = new TopBottom[]{
            new TopBottom(R.string.T1_Story,R.string.T1_Ans1,R.string.T1_Ans2),
            new TopBottom(R.string.T2_Story,R.string.T2_Ans1,R.string.T2_Ans2),
            new TopBottom(R.string.T3_Story,R.string.T3_Ans1,R.string.T3_Ans2)
    };
